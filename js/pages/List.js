    ...
    <main v-else class="page-list">
      ...
      <div class="meta-container">
        <div class="meta">
          ...
          <p>If you were banned from the server due to a reason or few, you are still allowed to submit your records and levels by directly messaging list staff (pixelfactorial, galbereal, blightedcoconut_05273 or sadisyourlife.).</p>
