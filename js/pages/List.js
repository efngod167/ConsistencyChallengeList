  ...
  template: `
    ...
    <main v-else class="page-list">
      ...
      <div class="meta-container">
        ...
        <p>Your level <b>must be consistency based.</b> A good example of a consistency challenge is <b>DIOOZ</b> by JoinMolten, and a bad example is <b>swi consistency II</b> by SeCeP. Challenges that repeat a specific part of the level aren't allowed, as they aren't really considered a consistency challenge.</p>
        ...
        <p>FPS Bypass is allowed <b>as long as you're not</b> bypassing above 360 FPS or under 60 FPS. Physics Bypass, however, isn't allowed. This rule doesn't apply to levels possible <b>only</b> on listed framerate - this doesn't count for levels that can use multiple framerates (<b>Show me your heart</b>, for example) as the lowest can be from 144 to 240 FPS, <b>not</b> TPS. For any confusion, completions/verifications <b>will always count</b> as X FPS/240 TPS, unless the level requires you to do it on for ex. 144 FPS/144 TPS.</p>
        ...
        <p>Click Between Frames/Click on Steps/Click Between Steps/Click Between MoonFrosts records are allowed, unless the level is cube and the player is <b>not using</b> CBF/CBS. This rule can be ignored if the cube challenge isn't possible on any framerate, including the limit as it's 240 FPS/TPS.</p>
		<p>You <b>must</b> beat the level on the listed framerate. This is an exception for wave levels, if the required FPS for the level is for ex. 240 and CBF/CBS can be used for it - hence why levels like <b>kom real con</b> don't allow CBF completions. This doesn't count for 60 FPS levels - if the CPS of the level is 7.5, you're allowed to do it on higher framerates (if it's aligned), such as 90 FPS, 120 FPS etc.</p>
        ...
        <p>You are allowed to use Show Hitboxes on Death, but your record will be denied if you use it for levels that are hard to see or are invisible, for ex. <b>tueml cereal</b>. This rule doesn't apply to levels that were <b>verified</b> with it. If you're unsure if the level you're playing allows Show Hitboxes on Death, make sure to ask staff members!</p>
        <p>Once a level falls onto the Legacy List, we no longer accept records for them.</p>
		<p>You are <b>not</b> allowed to use <b>any</b> skips on any given level.</p>
		<h4>Allowed Hacks</h4>
